    ...
    SenecaPlum.prototype.actPromise = function (pin, user) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var timeout = setTimeout(function () {
                ...
                _this.seneca.close(); // close the connection
                reject(new error_1.TimeoutPlumError("Internal timeout during aceessing the service"));
            }, _this.options.seneca.timeout - 100);
        ...
        return (function (pin, done) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        if (err_1 instanceof error_1.PlumError) {
                            done(null, { status: false, error: err_1 });
                        }
                        else {
                            done(null, { status: false, error: new error_1.ServerPlumError(err_1.message) });
                        }
                        return [3 /*break*/, 3];
