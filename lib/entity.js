...
var ServiceEntity = (function () {
    ...
    ServiceEntity.prototype.addDefaultService = function (seneca, options) {
        var _this = this;
        seneca.add(this.pin(this.name, undefined), this.handleService(function (args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (args.nonErrorDefault) {
                    return [2 /*return*/, Promise.resolve()];
                }
                else {
                    throw new error_1.NotAllowedPlumError("Service not found.");
                }
                return [2 /*return*/];
            });
        }); }));
