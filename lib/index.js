...
var SenecaPlum = /** @class */ (function () {
    ...
    SenecaPlum.prototype.anonymize = function (pin) {
        ...
        return new Promise(function (resolve, reject) {
            _this.act(pin, function (err, data) {
                if (err) {
                    ...
                    console.log("[Microplum] ANSWER [status:" + ((data) ? data.status : '') + "] <= " + JSON.stringify(_this.anonymize(pin)));
        ...
        return function (pin, done) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _a.apply(void 0, _b.concat([(_c.data = _d.apply(this, [_e.sent()]), _c)]));
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _e.sent();
                        done(null, { status: false, error: error_1.transformSenecaError(err_1) });
                        throw err_1;
